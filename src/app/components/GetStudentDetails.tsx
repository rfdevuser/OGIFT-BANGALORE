    ...
    <div>
       ...
       <form onSubmit={(e)=>{e.preventDefault();handleSubmit(e);}}>
         <div className="-mx-4 flex flex-wrap ">
                  <div className="w-full px-10 md:w-1/2  pt-10">
                    <div className="mb-8">
                    ...
                    <button type="submit" className="rounded-sm bg-dark px-9  py-4 text-base font-medium text-white  hover:bg-[#701a75] dark:shadow-submit-dark">VERIFY</button>
                  </div>
                  </div>
